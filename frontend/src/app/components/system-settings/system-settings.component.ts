              ...
              <div class="p-6 space-y-5">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                  <div>
                    ...
                    <input [(ngModel)]="configForm.companyName" class="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" placeholder="MACI/SRESEAUX" />
                  </div>
                  <div>
                    <label class="text-xs font-bold text-on-surface-variant block mb-1.5">{{ t('params.supportEmail') }}</label>
                    <input [(ngModel)]="configForm.supportEmail" type="email" class="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all" placeholder="support@maci-sreseaux.com" />
                  </div>
                </div>
                <div>
