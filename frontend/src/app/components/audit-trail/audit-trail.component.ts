          ...
          <form class="bg-white rounded-xl shadow-sm border border-slate-100 p-6 space-y-4" (ngSubmit)="applyFilters()">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
              <label class="space-y-2 text-xs font-semibold text-on-surface-variant">
                ...
                <input [(ngModel)]="filters.user" name="user" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-on-surface" />
              </label>
              <label class="space-y-2 text-xs font-semibold text-on-surface-variant">
                <span>{{ t('audit.filterAction') }}</span>
                <input [(ngModel)]="filters.action" name="action" class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-on-surface" />
              </label>
              <label class="space-y-2 text-xs font-semibold text-on-surface-variant">
