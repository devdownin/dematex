    ...
    <div class="p-8 space-y-8 font-['Inter']">
      ...
      <div class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <div class="px-6 py-4 flex flex-wrap justify-between items-center bg-white border-b border-slate-100 gap-4">
          ...
          <p class="text-[11px] font-semibold text-on-surface-variant">Displaying <span class="font-bold text-primary">1-15</span> of 12,842 records</p>
        </div>
          ...
          <table class="w-full text-left">
            ...
            <tbody class="divide-y divide-slate-100">
              <tr *ngFor="let doc of documents" class="zebra-stripe tonal-stack">
                ...
                <td class="px-6 py-4 text-xs font-medium text-on-surface-variant">2023-Q4-DEC</td>
                <td class="px-6 py-4 text-xs font-medium text-on-surface-variant">LUX-BNK-01</td>
                <td class="px-6 py-4 text-xs font-medium text-on-surface-variant">Standard Chartered</td>
                <td class="px-6 py-4">
        ...
        <div class="px-6 py-4 border-t border-slate-100 flex justify-between items-center">
          ...
          <div class="flex items-center gap-4 text-on-surface-variant">
             ...
             <span class="text-xs font-bold"><span class="text-primary">1</span> of 856</span>
