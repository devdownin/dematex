...
export interface DocumentDTO { documentId: string; type: DocumentType; entityCode: string; issuerCode: string; period: string; status: AcknowledgementType; createdAt: string; updatedAt: string; deadline: string; isLate: boolean; hash?: string; }
